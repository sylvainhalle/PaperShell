...
%% PaperShell v3.0
%%
%% Authors: Marty McFly, Clara Clayton, Emmett Brown
%%
%% NOTE: this file must first be compiled once with lualatex.
%% See the file Readme.md to understand what to do.
%%
...
\else
\IfFileExists{gen/preamble.inc.tex}{}
{\errmessage{Run once with LuaLaTeX to generate}}
\fi
\input{settings.tex}
