...
// as the main program
if (count($argv) > 0 && $argv[1] === "--show-version")
{
	echo $version_string;
	exit(0);
}
...
{$autogen_comment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[{$point_size_string}{$easychair_type_string}]{easychair}
...
EOD;
  ...
  file_put_contents($out_folder."preamble-easychair.inc.tex", $out);
...
EOD;
  ...
  $out .= "\\input{appendices.tex}\n";
  $out .= "\\end{document}\n";
  file_put_contents($out_folder."postamble-easychair.inc.tex", $out);
} // }}}
