...
{$autogen_comment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[sttt{$point_size_string_comma}{$config["otheropts"]}]{svjour} % Remove referee for final version
...
{$autogen_comment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[letterpaper,USenglish{$point_size_string_comma}{$config["otheropts"]}]{lipics-v2016}
...
else
{
	...
	echo "ieee-trans, acmconf, elsevier, springer, aaai, acmjour, eptcs, stvr,\n";
	echo "lipics, easychair, usenix.\n";
	exit(1);
}
